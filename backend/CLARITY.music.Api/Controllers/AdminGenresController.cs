...
public class AdminGenresController : ControllerBase
{
    ...
    public AdminGenresController(ILookupMutationService lookupMutations, ILookupQueryService lookupQueries)
    {
    ...
    public async Task<IActionResult> Create([FromBody] NamedLookupSaveRequest request)
    {
        ...
        var result = await _lookupMutations.CreateGenreAsync(request, User.Identity?.Name, CancellationToken.None);
    ...
    public async Task<IActionResult> Update(int id, [FromBody] NamedLookupSaveRequest request)
    {
        ...
        var result = await _lookupMutations.UpdateGenreAsync(id, request, User.Identity?.Name, CancellationToken.None);
        return ToActionResult(result);
    }
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        var result = await _lookupMutations.DeleteGenreAsync(id, CancellationToken.None);
        return ToActionResult(result);
    }
